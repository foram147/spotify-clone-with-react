import { BsSearch, BsFileArrowDown, BsPlusSquare } from "react-icons/bs";
    ...
    <nav>
      <div className="vertical-nav" id="sidebar">
          ...
          <div className="mx-1 mb-1 active-link">
            <li className="nav-item px-4">
              <div>
                ...
                <Link to="/" className="nav-link active-link d-inline-block">
                  Home
                </Link>
              </div>
            </li>
          ...
          <div className="mx-1 mb-1">
            <li className="nav-item px-4">
              <div className="justify-content-center">
                <BsSearch size={20} />
                <Link className="nav-link d-inline-block"> Search </Link>
              </div>
            </li>
          </div>
          <div className="mx-1 mb-1">
            <li className="nav-item px-4">
              <div>
                <VscLibrary size={20} />
                <Link className="nav-link d-inline-block"> Your Library </Link>
              </div>
            </li>
          </div>
        </ul>
        <ul className="nav flex-column mt-3">
          <div className="mx-1 mb-1">
            <li className="nav-item px-4">
              <div onclick="playlistCreator()">
                <BsPlusSquare size={20} />
                <Link className="nav-link d-inline-block">Create playlist</Link>
              </div>
            </li>
          </div>
          <div className="mx-1 mb-0">
            <li className="nav-item px-4">
              <div>
                <BiHeartSquare size={25} />
                <Link to="/favorites" className="nav-link d-inline-block">
                  Liked Songs
                </Link>
              </div>
            </li>
        ...
        <ul className="nav flex-column mt-3">
          <div id="playlist-holder" className="mx-1 mb-1"></div>
        </ul>
        <ul className="nav flex-column mt-3">
          <div className="mx-1 mb-0">
            <li className="nav-item px-4">
              <div className="d-flex ">
                <BsFileArrowDown size={20} className="mr-auto" />
                <Link className="nav-link  ml-auto"> Install App </Link>
              </div>
            </li>
          </div>
        </ul>
